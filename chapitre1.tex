...
In this section. we will discuss the mobile apps that already exist and cover some chapters of what we have seen in figure 1. \\
\indent There are a lot of websites and applications that include some points, but there is no open-source project that includes all the points of STRM 1.\\
\indent We present some open-source projects that we found are very close to what we will do in our project.
